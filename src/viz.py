...
#%%
def lineplot_evolucao_casos(frame, outputfolder=out, filename='01-evolucao-casos.png'):
    plt.figure()
...
#%%
def lineplot_casos_ativos_investigacao(frame, outputfolder=out, filename='02-casos-ativos-e-investigacao.png'):
    plt.figure()
...
#%%
def lineplot_evolucao_casos_ativos(frame, outputfolder=out, filename='03-evolucao-casos-ativos.png'):
    plt.figure()
...
# %%
def lineplot_evolucao_hospitalizados(frame, outputfolder=out, filename='04-evolucao-hospitalizados.png'):
    plt.figure()
...
# %%
def lineplot_relacao_confirmados_recuperados(frame, outputfolder=out, filename='05-relacao-confirmados-recuperados.png'):
    plt.figure()
...
# %%
def lineplot_relacao_ativos_investigados(frame, outputfolder=out, filename='06-relacao-ativos-investigacao.png'):
    plt.figure()
...
def lineplot_media_movel(frame, days=7, outputfolder=out, filename='07-media-movel.png'):
    plt.figure()
...
def lineplot_evolucao_obitos(frame, outputfolder=out, filename='08-evolucao-obitos.png'):
...
# %%
def barplot_evolucao_obitos_mes(frame, outputfolder=out, filename='09-evolucao-obitos-por-mes.png'):
...
def barplot_novos_casos_recuperacoes_semanal(frame, outputfolder=out, filename='10-relacao-novos-casos-recuperados-semanal.png'):
...
def lineplot_taxa_testes_positivados(frame, outputfolder=out, filename='11-taxa-testes-positivados.png'):
...
if __name__ == "__main__":
    ...
    lineplot_relacao_ativos_investigados(frame)
    barplot_novos_casos_recuperacoes_semanal(frame)
    barplot_evolucao_obitos_mes(frame)
    lineplot_relacao_confirmados_recuperados(frame)